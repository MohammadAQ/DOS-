...
database_init += [
    ...
    Book('How to finish Project 3 on time', 'University Problems', 40, 10.00),
    Book('Why theory classes are so hard', 'University Problems', 38, 10.00),
    Book('Spring in the Pioneer Valley', 'Developer Life', 15, 10.00),
]
